                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            if (context.mounted) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(dismissDirection: DismissDirection.horizontal, content: Text('¡Felicidades! Eres VIP 👑'), backgroundColor: Color(0xFFD97706)));
                            }
                          },
                          child: Container(
