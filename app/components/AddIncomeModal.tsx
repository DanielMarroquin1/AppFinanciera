    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      >
        ...
        <div className={`${isDark ? "bg-gradient-to-r from-green-700 to-emerald-700" : "bg-gradient-to-r from-green-600 to-emerald-600"} px-6 py-5 rounded-t-3xl`}>
          <div className="flex items-center justify-between text-white mb-2">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl">Nuevo Ingreso</h2>
            </div>
            <button onClick={onClose} className="hover:bg-white/20 rounded-full p-1 transition-colors">
              <X className="w-6 h-6" />
            </button>
          </div>
          <p className="text-sm text-white/90">Registra tus ingresos para llevar un mejor control</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto" style={{ maxHeight: "calc(90vh - 120px)" }}>
          ...
          <div className="mb-5">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0.00"
                required
                className={`w-full ${isDark ? "bg-gray-700 border-gray-600 text-white placeholder-gray-500" : "bg-white border-gray-300 text-gray-900 placeholder-gray-400"} border-2 py-4 pl-12 pr-4 rounded-xl focus:outline-none focus:border-green-500 transition-all text-2xl font-semibold`}
              />
            </div>
          </div>
          ...
          <div className="mb-5">
            ...
            <div className="relative">
              ...
              <textarea
                ...
                placeholder="Ej: Pago de proyecto freelance..."
                rows={3}
                className={`w-full ${isDark ? "bg-gray-700 border-gray-600 text-white placeholder-gray-500" : "bg-white border-gray-300 text-gray-900 placeholder-gray-400"} border-2 py-3 pl-12 pr-4 rounded-xl focus:outline-none focus:border-green-500 transition-all resize-none`}
              />
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className={`w-full ${isDark ? "bg-gray-700 border-gray-600 text-white" : "bg-white border-gray-300 text-gray-900"} border-2 py-3.5 pl-12 pr-4 rounded-xl focus:outline-none focus:border-green-500 transition-all`}
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            className={`w-full ${isDark ? "bg-gradient-to-r from-green-700 to-emerald-700 hover:from-green-600 hover:to-emerald-600" : "bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700"} text-white py-4 rounded-xl transition-all shadow-lg hover:shadow-xl font-medium`}
          >
            Agregar Ingreso
          </button>
        </form>
