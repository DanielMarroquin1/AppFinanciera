                ...
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    if (amount > card.currentBalance) {
                      ScaffoldMessenger.of(ctx).showSnackBar(const SnackBar(dismissDirection: DismissDirection.horizontal, content: Text('No puedes abonar más del saldo adeudado.')));
                      return;
                    }
                    if (amount > 0) {
                      ...
                      if (ctx.mounted) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(dismissDirection: DismissDirection.horizontal, content: Text('Pago de ${CurrencyFormatter.format(amount, currencyCode)} registrado con éxito! 🎉')));
                      }
                    }
                  },
                                            ...
                                            actions: [
                                              ...
                                              TextButton(
                                                onPressed: () {
                                                  ...
                                                  Navigator.pop(ctx);
                                                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(dismissDirection: DismissDirection.horizontal, content: Text('Tarjeta eliminada'), backgroundColor: Colors.red));
                                                },
