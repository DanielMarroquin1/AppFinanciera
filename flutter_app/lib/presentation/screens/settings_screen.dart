                ...
                ...voices.map((v) {
                  ...
                  return GestureDetector(
                    onTap: () async {
                      ...
                      try {
                        // Reseteamos siempre la velocidad y tono para sonar lo más natural posible (voces de sistema puras).
                        await flutterTts.setSpeechRate(0.5);
                        await flutterTts.setPitch(1.0);
                        
                        // Utilizamos diferentes "Locales" para obligar a iOS/Android a usar diferentes 
                        // actores de voz (ej: Paulina en MX, Mónica en ES), lo cual suena mucho más natural
                        // que modificar el tono (pitch).
                  ...
                  return Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            const Icon(LucideIcons.map, size: 16, color: Color(0xFF3B82F6)),
                            const SizedBox(width: 8),
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Column(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.all(20),
            child: Text(loc.get('select_currency'), style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: isDark ? Colors.white : Colors.black)),
          ),
          const Divider(),
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  title: Text(currency['name']!, style: TextStyle(color: isDark ? Colors.white : Colors.black, fontWeight: isSelected ? FontWeight.bold : FontWeight.normal)),
